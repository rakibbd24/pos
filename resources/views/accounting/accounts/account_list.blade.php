                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            @if($account->id == '1')
                                @php
                                    $expenses_amount = \App\Models\Expense::get();

                                    if($expenses_amount != null)
                                    {
                                        $total_amount_expense = $expenses_amount->sum('amount');
                                    }else{
                            ...
                            @if($account->id == '3')
                                @php
                                    $deposits_amount = \App\Models\Deposit::get();
                                    if($deposits_amount != null)
                                    {
                                        $total_amount_deposit = $deposits_amount->sum('amount');
                                    }else{
