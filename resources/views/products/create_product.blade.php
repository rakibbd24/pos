                ...
                <div class="card-body">
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <v-select placeholder="Select profile" v-model="product.profile" onchange="setProduct(this.value);"
                                :reduce="(option) => option.value"
                                :options="profiles.map(profiles => ({label: profiles.name, value: profiles.name}))">
                            </v-select>
                        ...
                        {{-- <div class="col-12" id="add_remove_unit_value">
                            <table class="table table-bordered datatable-basic" id="upload_unit">
                                <thead>
                                    <tr>
                                        <th><span class="text-danger font-weight-bolder">*</span> File</th>
                                        <th></th>
                                    </tr>
                                </thead>

                                <tbody id="remove_all_tr">
                                    <tr id="tr${uid}">
                                        <td>
                                            <input type="text" name="attatchment" class="form-control" id="attatchment">
                                        </td>
                                        <td>
                                            <a href="#" class="btn btn-danger" onclick="event.preventDefault();removeUnitTR(${uid})">Remove</a>
                                        </td>
                                    </tr>
                                </tbody>
                                <tfoot>
                                    <tr>
                                        <td colspan="1"></td>
                                        <td>
                                            <a href="#" onclick="event.preventDefault();appendUnitTR();" class="btn btn-success" id="appendUnitTR">Add File</a>
                                        </td>
                                    </tr>
                                </tfoot>
                            </table>
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="input-group">
                                <div class="input-group mb-3">
                                <input type="text" class="form-control" id="port"
                                placeholder="Folder Name" v-model="product.attatchement_folder_name">
                                </div>
                            </div>
                        </div>
                        <div class="col-12">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4" v-if="product.type == 'is_single' || product.type == 'is_service'">
                            ...
                            <input type="text" class="form-control" id="price" value="0" placeholder="{{ __('translate.Enter_Product_Price') }}"
...
<script>
    Vue.component('v-select', VueSelect.VueSelect)
      ...
      var app = new Vue({
          ...
          //-----------------------------Autoload function-------------------
          created() {
                // Automatically call generateNumber() when the component is created
                this.generateNumber();
            },
        //   created() {
        //   }
...
<script>
    function shuffle(string) {
        ...
        //UNIT TR APPEND
        function appendUnitTR()
        {
            var ran_one     = Math.floor(Math.random() * 999)+111;
            var ran_two     = Math.floor(Math.random() * 999)+111;
            var ran_three   = Math.floor(Math.random() * 999)+111;
            var final = shuffle(ran_one.toString())+shuffle(ran_two.toString())+shuffle(ran_three.toString());
            var uid = shuffle(final);
            uid = Number(uid);
            var i = 1;

            var tr = `<tr id="tr${uid}">
                        <td>
                            <input type="text" name="attatchment[]" id="image" class="form-control">
                        </td>
                        <td>
                            <a href="#" class="btn btn-danger" onclick="event.preventDefault();removeUnitTR(${uid})">Remove</a>
                        </td>
                    ...
                    `;
            $("#upload_unit tbody").append(tr);
        }

        //UNIT TR REMOVE
        function removeUnitTR(uid)
        {
            $(`#upload_unit tbody #tr${uid}`).remove();
        }
</script>

<script>
    function setProduct(profile)
    {
        alert(profile);
    }
</script>
