          ...
          <div class="row pos-card-left">
              ...
              <validation-observer ref="create_pos">
                <form>
                  ...
                  <div class="card m-0 card-list-products">
                          ...
                          <div>
                            ...
                            @endif
                              ...
                              <a @click="Modal_Updat_Detail(detail)"
                                  ...
                                  title="Edit" style="font-size:15px;">
                                  Edit Price
                              </a>
                    ...
                    <div>
                      <div class="summery-item mb-2 row d-none">
                      ...
                      <div class="summery-item mb-3 row d-none">
                      ...
                      <div class="modal-body">
                        ...
                        [
                          ...
                          {label: 'Fixed', value: '2'}
                            ...
                            <!-- Unit Sale -->
                            <div class="form-group col-md-6 d-none" v-if="detail.product_type != 'is_service'">
                            ...
                            <!-- imei_number -->
                            <div class="form-group col-md-12 d-none" v-show="detail.is_imei">
            ...
            <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12 mt-3">
              <div class="row">
                ...
                <div class="d-md-block col-12 col-lg-4 d-none">
                  <div class="card category-card d-none">
              ...
              axios
                ...
                .then(response => {
                  if (response.data.success === true) {
                    ...
                    window.open("/sales/" + response.data.id, "_blank");
